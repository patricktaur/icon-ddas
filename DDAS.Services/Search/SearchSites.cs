    ...
    public static class SearchSites
    {
        ...
        public static SearchQuery GetNewLiveSiteSearchQuery()
        {
            return new SearchQuery
            {
                ...
                {
                    new SitesToSearch { ExtractionMode = "Live", SiteName="FDA Warning Letters and Responses", SiteShortName="FDA Warning Letters ...", SiteEnum = SiteEnum.FDAWarningLettersPage, SiteUrl="http://www.fda.gov/ICECI/EnforcementActions/WarningLetters/default.htm" },

                    new SitesToSearch { ExtractionMode = "Live", SiteName="Clinical Investigators – Disqualification Proceedings (FDA Disqualified/Restricted)", SiteShortName="Disqualification Proceedings ...", SiteEnum = SiteEnum.ClinicalInvestigatorDisqualificationPage, SiteUrl="XXX" },
