...
namespace DDAS.Setup
{
    class Program
    {
        ...
        public void AddSitesInDbCollection(SitesToSearch Site)
        {
            ...
            var s11 =
                    new SitesToSearch { Mandatory = true, ExtractionMode = "DB", SiteName = "SAM/SYSTEM FOR AWARD MANAGEMENT", SiteShortName = "SAM/SYSTEM FOR AWARD ...", SiteEnum = SiteEnum.SystemForAwardManagementPage, SiteUrl = "https://www.sam.gov/portal/public/SAM", ExcludePI = false, ExcludeSI = false };
