...
namespace OpenXmlEmbedObjectNew
{
    ...
    public class OpenXmlHelper
    {
        ...
        static readonly List<string> validObjectExtensions = new List<string>() { ".xml", ".txt", ".zip", ".pdf" };
        ...
        //public void AddObject_Helper(string realFileName, string displayFileName)
        //{
        //    System.Threading.Thread t = new System.Threading.Thread(() => 
        //    AddObject(realFileName, displayFileName));
